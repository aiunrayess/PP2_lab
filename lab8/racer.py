...
backgroundpic = pygame.image.load('download12.tiff')
...
def introduction():
    ...
    while introduction:
        ...
        textSurf, textRect = text_objects("Its car game boy" + "Which one is better to dodge the cars", smalltext)
...
def game_loop():
    ...
    score = 0
    y2 = 7
    bumped = False  # Ensure this is properly initialized
    ...
    while not bumped:
        ...
        if x > 680 - car_width or x < 110:
            crash()
            bumped = True  # Set bumped to True only when the player crashes
...
pygame.display.setCaption("Car Game") 
